...
for(int rowNum=1;rowNum<findTestData("Data_File").getRowNumbers();rowNum++)
{
//WebUI.sendKeys(findTestObject('commonObj_FreeCRM/login_FreeCRM/email'), Username)

WebUI.sendKeys(findTestObject('commonObj_FreeCRM/login_FreeCRM/email'), findTestData("Data_File").getValue(1, rowNum))
//WebUI.sendKeys(findTestObject('commonObj_FreeCRM/login_FreeCRM/password'), Password)
WebUI.sendKeys(findTestObject('commonObj_FreeCRM/login_FreeCRM/password'), findTestData("Data_File").getValue(2, rowNum))
Thread.sleep(3000)
}
